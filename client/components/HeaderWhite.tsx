      ...
      <div className="absolute inset-0 opacity-80">
        <svg width="1920" height="176" viewBox="0 0 1920 176" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
          <g opacity="0.8">
            ...
            <path d="M0 56.3239H1920V176H0V56.3239Z" fill="url(#paint2_linear_115_5)"/>
          </g>
          <defs>
            <linearGradient id="paint0_linear_115_5" x1="960" y1="-1" x2="960" y2="118.676" gradientUnits="userSpaceOnUse">
              <stop offset="0.355769" stopColor="#050E16"/>
              <stop offset="1" stopColor="#020305" stopOpacity="0"/>
            </linearGradient>
            <linearGradient id="paint1_linear_115_5" x1="960" y1="28.1648" x2="960" y2="147.841" gradientUnits="userSpaceOnUse">
              <stop offset="0.235577" stopColor="#050E16"/>
              <stop offset="1" stopColor="#020305" stopOpacity="0"/>
            </linearGradient>
            <linearGradient id="paint2_linear_115_5" x1="960" y1="56.3239" x2="960" y2="176" gradientUnits="userSpaceOnUse">
